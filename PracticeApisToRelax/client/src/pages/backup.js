                                ...
                                {posts.map((post, index) => (
                                    <tr key={post.id}>
                                        <td className="text-center">
                                            ...
                                            >
                                                <FontAwesomeIcon
                                                    icon={post.active ? "check" : "times"} // Use the appropriate FontAwesome icon
                                                />{" "}
                                                {post.active ? "YES" : "NO"}
                                            </div>
                                        </td>
                                        ...
                                        <td className="text-center">
                                            ...
                                            >
                                                <FontAwesomeIcon
                                                    icon={post.locked ? "check" : "times"} // Use the appropriate FontAwesome icon
                                                />{" "}
                                                {post.locked ? "YES" : "NO"}
                                            </div>
                                        </td>
                                        <td className="text-center">
                                            <div
                                                type="checkbox"
                                                className={
                                                    post.isStickied ? "badge  bg-warning" : "badge  bg-danger"
                                                }
                                            >
                                                <FontAwesomeIcon
                                                    icon={post.isStickied ? "check" : "times"} // Use the appropriate FontAwesome icon
                                                />{" "}
